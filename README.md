...
<details>
  <summary> Task 6 - Working Prototype </summary>
   ...
   ## Obstacle Detector using VsdquadronMini
...
void setup() {
    ...
    TIM_TimeBaseStructure.TIM_Prescaler = SystemCoreClock / 1000000 - 1; // 1 µs resolution
